...
### Consider Scenario!
"Scenario" is a special game tree structure that has protected part as 'definition' and user added part as 'resolution'. The concept and use is explained with a sample as below:<br/>
...
To get started, find the game title 'Life and dead in Regular form' from the top of the app combo box or from the InfoViewer, and read it. Assumed the sample file, Sample_GBF_1_File.gbf, is open in the app.
...
<img src="img/Scenario 3-1.png" width="60%"alt="Scenario 3-1"/>  

<img src="img/Scenario 3.png"  width="60%" alt="Scenario 3"/>  
The board has to be shown as above.
